...
export default function Shop() {
  ...
  const staticProducts: Product[] = [
    { product_id: 1, name: "Organic Cotton T-Shirt", price: 450, image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&auto=format&fit=crop", category: "Clothing", rating: 4.8 },
    ...
    { product_id: 4, name: "Hemp Backpack", price: 795, image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800&auto=format&fit=crop", category: "Accessories", rating: 4.7 },
    ...
    { product_id: 7, name: "Linen Summer Dress", price: 1085, image: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=800&auto=format&fit=crop", category: "Clothing", rating: 4.7 },
    ...
    { product_id: 12, name: "Natural Soap Set", price: 320, image: "/images/natural-soap.jpg", category: "Personal Care", rating: 4.8 },
  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font mb-4">Shop All Yours</h1>
